...
**instantOS** is based on [Arch Linux](https://archlinux.org/) and maintains full
compatibility with the Arch Wiki and AUR.
It uses a custom window manager/compositor with a bunch of facilitating custom software
