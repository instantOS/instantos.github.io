...
works by scanning your entire hard drive first to build an index that it then
...
that contains the file. Choosing an option in these dialogs can be done using
